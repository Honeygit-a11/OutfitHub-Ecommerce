...
var SvgIcon = React19.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  const hasSvgAsChild = React19.isValidElement(children2) && children2.type === "svg";
  const ownerState = {
    ...props,
    color,
    component,
...
var PaginationItem = React25.forwardRef(function PaginationItem2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiPaginationItem"
  });
...
var Pagination = React26.forwardRef(function Pagination2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiPagination"
  });
